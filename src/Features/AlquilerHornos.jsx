  ...
  const hornos = [
    {
      ...
      tiempo: "8-12 horas",
      precio: "$800",
      descripcion: "Perfecto para ceramistas independientes y piezas personales",
      especificaciones: [
    ...
    },
    {
      ...
      tiempo: "12-16 horas",
      precio: "$1,400",
      descripcion: "La opción más versátil para talleres y producciones regulares",
      especificaciones: [
  ...
  const serviciosIncluidos = [
    {
      ...
      descripcion: "Te ayudamos a programar la cocción según tu tipo de piezas y esmaltes"
    },
    {
      icono: <HiScale className="w-8 h-8" />,
      titulo: "Carga y Descarga",
      descripcion: "Servicio de carga profesional incluido para optimizar el espacio"
    },
    {
      icono: <HiClock className="w-8 h-8" />,
      titulo: "Monitoreo 24/7",
      descripcion: "Supervisión constante del proceso de cocción por nuestros expertos"
    },
    {
      icono: <HiCheck className="w-8 h-8" />,
      titulo: "Garantía de Proceso",
      descripcion: "Garantizamos la correcta ejecución del ciclo de cocción programado"
    }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-green-500 to-green-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <HiFire className="w-20 h-20 mx-auto mb-6 text-green-100" />
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Alquiler de Hornos
          </h1>
          <div className="w-24 h-1 bg-green-200 mx-auto mb-6"></div>
          <p className="text-xl md:text-2xl max-w-4xl mx-auto mb-8 text-green-100">
            Cocción profesional para tus piezas cerámicas. Hornos eléctricos y a gas 
            con monitoreo experto para resultados perfectos en cada cocción.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Contamos con diferentes tipos de hornos para satisfacer todas tus necesidades 
              de cocción, desde piezas personales hasta producciones comerciales.
            </p>
          </div>
            ...
            {hornos.map((horno) => (
              <div 
                ...
                className={`bg-gray-50 rounded-lg p-6 hover:shadow-lg transition-shadow cursor-pointer ${
                  selectedHorno === horno.id ? 'ring-2 ring-green-500 bg-green-50' : ''
                }`}
                onClick={() => setSelectedHorno(selectedHorno === horno.id ? null : horno.id)}
              >
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">{horno.nombre}</h3>
                    <p className="text-gray-600 mb-3">{horno.descripcion}</p>
                  </div>
                  <div className="text-right">
                    <div className="text-2xl font-bold text-green-600">{horno.precio}</div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                  <div className="text-center">
                    <div className="text-lg font-semibold text-green-600">{horno.capacidad}</div>
                    <div className="text-xs text-gray-500">Capacidad</div>
                  </div>
                  <div className="text-center">
                    <div className="text-lg font-semibold text-green-600">{horno.temperatura}</div>
                    <div className="text-xs text-gray-500">Temp. Máx</div>
                  </div>
                  <div className="text-center">
                    <div className="text-lg font-semibold text-green-600">{horno.tiempo}</div>
                    <div className="text-xs text-gray-500">Duración</div>
                  </div>
                  <div className="text-center">
                    <div className="text-lg font-semibold text-green-600">{horno.ideal}</div>
      ...
      <section className="py-20 bg-green-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-green-500 mx-auto mb-6"></div>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Ofrecemos diferentes tipos de cocción según las necesidades de tus piezas y proyectos.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {tiposCoccion.map((coccion, index) => (
              <div key={index} className="bg-white rounded-lg p-6 shadow-sm">
                <div className="flex items-start justify-between mb-4">
                  <h3 className="text-xl font-semibold text-gray-900">{coccion.tipo}</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-green-500 mx-auto mb-6"></div>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Más que solo alquiler de hornos, te ofrecemos un servicio integral para garantizar 
              los mejores resultados en tus cocciones.
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Proceso de Reserva</h2>
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Consulta y Evaluación</h3>
                    <p className="text-gray-600">Contáctanos para evaluar tus piezas y determinar el tipo de cocción necesaria.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center text-white font-bold flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Agendamos la fecha de cocción según disponibilidad y tipo de horno.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center text-white font-bold flex-shrink-0">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Entrega de Piezas</h3>
                    <p className="text-gray-600">Trae tus piezas 24hs antes de la cocción para inspección y carga.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center text-white font-bold flex-shrink-0">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Cocción y Entrega</h3>
                    <p className="text-gray-600">Realizamos la cocción y te notificamos cuando esté listo para retirar.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Normas de Seguridad</h2>
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <div className="flex items-center space-x-2 mb-4">
                  <HiExclamationTriangle className="w-6 h-6 text-orange-500" />
                  <h3 className="text-xl font-semibold text-gray-900">Importante leer antes de traer piezas</h3>
                </div>
                ...
                <div className="mt-6 p-4 bg-green-50 rounded-lg">
                  <p className="text-green-800 text-sm">
                    <strong>Garantía:</strong> Garantizamos la correcta ejecución del proceso de cocción. 
                    No nos responsabilizamos por roturas debido a defectos en la fabricación de las piezas.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Cocción Individual</h3>
            ...
            <div className="bg-green-50 rounded-lg p-6 border-2 border-green-200">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Bonos Mensuales</h3>
              <div className="space-y-3">
                <div className="flex justify-between">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Servicios Extra</h3>
              <div className="space-y-3">
                <div className="flex justify-between">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <div className="bg-white/20 backdrop-blur-sm rounded-lg p-6">
              <HiPhone className="w-8 h-8 text-green-100 mx-auto mb-3" />
              <p className="text-green-100 font-semibold">Teléfono</p>
              <p className="text-green-200">{contactInfo.telefono}</p>
            </div>
            <div className="bg-white/20 backdrop-blur-sm rounded-lg p-6">
              <HiEnvelope className="w-8 h-8 text-green-100 mx-auto mb-3" />
              <p className="text-green-100 font-semibold">Email</p>
              <p className="text-green-200">{contactInfo.email}</p>
            </div>
            <div className="bg-white/20 backdrop-blur-sm rounded-lg p-6">
              <HiMapPin className="w-8 h-8 text-green-100 mx-auto mb-3" />
              <p className="text-green-100 font-semibold">Dirección</p>
              <p className="text-green-200">{contactInfo.direccion}</p>
            </div>
            <div className="bg-white/20 backdrop-blur-sm rounded-lg p-6">
              <HiClock className="w-8 h-8 text-green-100 mx-auto mb-3" />
              <p className="text-green-100 font-semibold">Horarios</p>
              <p className="text-green-200">{contactInfo.horarios}</p>
            </div>
          </div>
          ...
          <div className="space-y-4 sm:space-y-0 sm:space-x-4 sm:flex sm:justify-center">
            <a
              ...
              className="inline-flex items-center px-8 py-3 bg-white text-green-600 rounded-lg hover:bg-green-50 transition-colors font-semibold"
            >
            ...
            <a
              ...
              className="inline-flex items-center px-8 py-3 bg-green-700 text-white rounded-lg hover:bg-green-800 transition-colors font-semibold"
            >
